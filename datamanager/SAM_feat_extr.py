...
def _embed_clip_sam_tiles(image, sam_encoder):
    ...
    for mode in ['default', 's', 'm', 'l']:
        tiles = seg_images[mode] #Hay tantos tiles como segmentaciones
        
        #MODIFICATION TO GET A COMBINED CLIP DESCRIPTOR WITH THE BBOX CONTEXT
        #bbox_tiles = get_bbox_tiles(seg_map[mode], aug_imgs).to("cuda")
        tiles = tiles.to("cuda")
        with torch.no_grad():
        ...
        #joined_embed = 0.6 * clip_embed + 0.4 * clip_bbox_embed #In the official code they have 0.75, 0.25
...
def get_bbox_tiles(seg_map, image):
    ...
    for i in range(seg_map.max() + 1):
        ...
        cropped_img = image[0, :, bbox[1]:bbox[3], bbox[0]:bbox[2]]
...
if __name__ == '__main__':
    ...
    sam_ckpt_path = "/home/lmur/FUSION_FIELDS/Lorenzo_Feature_Fields_v2/sam_vit_h_4b8939.pth"
    ...
    scene_list = ["P01_01"] #"P03_04", "P04_01", "P05_01", "P06_03", "P08_01", "P09_02", "P13_03", "P16_01", "P21_01"
    for scene in scene_list:
        ...
        print('The number of loaded images is:', len(imgs))
        save_folder = os.path.join('/home/lmur/FUSION_FIELDS/Lorenzo_Feature_Fields_v2/outputs', scene, 'SAM_CLIP_features_v2')
