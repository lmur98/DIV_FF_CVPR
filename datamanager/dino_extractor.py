...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vitb8', stride: int = 4, model: nn.Module = None, device: str = 'cuda'):
        """
